...
BOOST_AUTO_TEST_CASE(prepared)
{
  ...
  if (!boost::starts_with(conf.cassandara_version(), "1.")) {
    BatchTests tester;
    ...
    test_utils::CassFuturePtr prepared_future(cass_session_prepare(tester.session,
    ...
    BOOST_TEST_MESSAGE("Unsupported Test for Cassandra v" << conf.cassandara_version() << ": Skipping batch/prepared");
    BOOST_REQUIRE(true);
  }
}
...
BOOST_AUTO_TEST_CASE(simple)
{
  ...
  if (!boost::starts_with(conf.cassandara_version(), "1.")) {
    ...
    boost::unit_test::unit_test_log_t::instance().set_threshold_level(boost::unit_test::log_messages);
    BOOST_TEST_MESSAGE("Unsupported Test for Cassandra v" << conf.cassandara_version() << ": Skipping batch/simple");
    BOOST_REQUIRE(true);
  }
}
...
BOOST_AUTO_TEST_CASE(mixed)
{
  ...
  if (!boost::starts_with(conf.cassandara_version(), "1.")) {
    ...
    boost::unit_test::unit_test_log_t::instance().set_threshold_level(boost::unit_test::log_messages);
    BOOST_TEST_MESSAGE("Unsupported Test for Cassandra v" << conf.cassandara_version() << ": Skipping batch/mixed");
    BOOST_REQUIRE(true);
  }
}
...
BOOST_AUTO_TEST_CASE(invalid_batch_type)
{
  ...
  if (!boost::starts_with(conf.cassandara_version(), "1.")) {
    ...
    boost::unit_test::unit_test_log_t::instance().set_threshold_level(boost::unit_test::log_messages);
    BOOST_TEST_MESSAGE("Unsupported Test for Cassandra v" << conf.cassandara_version() << ": Skipping batch/invalid_batch_type");
    BOOST_REQUIRE(true);
  }
}
...
BOOST_AUTO_TEST_CASE(counter_mixed)
{
  ...
  if (!boost::starts_with(conf.cassandara_version(), "1.")) {
    ...
    boost::unit_test::unit_test_log_t::instance().set_threshold_level(boost::unit_test::log_messages);
    BOOST_TEST_MESSAGE("Unsupported Test for Cassandra v" << conf.cassandara_version() << ": Skipping batch/counter_mixed");
    BOOST_REQUIRE(true);
  }
}
